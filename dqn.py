...
class DQN(nn.Module):
    def __init__(self, state_size, action_size, hidden_size=100, classify=False):
        super(DQN, self).__init__()
        # V(s)
        self.fc2_value = nn.Linear(hidden_size + classify*2, hidden_size)
        self.out_value = nn.Linear(hidden_size, 1)
        # Q(s,a)
        self.fc2_advantage = nn.Linear(hidden_size + classify*2 + action_size, hidden_size)   
